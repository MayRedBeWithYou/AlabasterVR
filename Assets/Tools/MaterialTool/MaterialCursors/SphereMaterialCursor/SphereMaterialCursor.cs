...
// ***********************************************************************
// <copyright file="SphereMaterialCursor.cs" company="">
...
/// <summary>
/// Class SphereMaterialCursor.
/// Implements the <see cref="MaterialCursor" />
/// </summary>
/// <seealso cref="MaterialCursor" />
public class SphereMaterialCursor : MaterialCursor
{
    private SphericalCursor cursor;
    ...
    {
        cursor = GetComponent<SphericalCursor>();
